...
export default function FitoPage() {
  ...
  const handlePredict = async () => {
    ...
    try {
      ...
      // Use the environment variable if configured, otherwise fall back to local development URL
      const backendBaseUrl = process.env.NEXT_PUBLIC_BACKEND_URL || `${window.location.protocol}//${window.location.hostname}:8000`
