-- ============================================================================
-- FITO USER PROFILES - DATABASE SCHEMA EXTENSION (FIXED VERSION)
-- ============================================================================
...
-- This version safely handles existing objects by dropping them first
...
DROP TRIGGER IF EXISTS generate_user_full_name ON user_profiles;
...
-- NOTE: This trigger is DISABLED by default to avoid signup errors
-- Enable it after verifying the user_profiles table is working
...
-- Create the trigger (DISABLED - see note above)
-- Uncomment the line below after verifying setup
-- CREATE TRIGGER on_auth_user_created_create_user_profile
--   AFTER INSERT ON auth.users
--   FOR EACH ROW
--   EXECUTE FUNCTION create_user_profile_on_signup();

COMMENT ON FUNCTION create_user_profile_on_signup IS 'Automatically creates user profile when user signs up (DISABLED by default)';
